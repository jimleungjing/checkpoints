...
if __name__ == '__main__':
    ...
    parser.add_argument('--outputPath', type=str, default='./AB_train5k_test10k_lmdb', help='path to dataset')
    ...
    parser.add_argument('--mixedWeight', type=float, default=0.50, help="weights for mixed")
    ...
    # opt.outputPath += "_Syn%dk" % (opt.nSize // 1e3)
